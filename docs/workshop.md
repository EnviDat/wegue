...
<template>
  <wgu-app-tpl>
    <v-card class="myCard" slot="wgu-before-content">
      <v-card-title> Point Tool </v-card-title>

      <v-card-text> This tool can add points to the map. </v-card-text>
...
<template>
  ...
  >
    ...
    -->
    <v-card-text> Hello Wegue </v-card-text>
  </wgu-module-card>
</template>
