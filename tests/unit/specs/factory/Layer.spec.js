...
describe("LayerFactory", () => {
  ...
  it("has a correct wfsFormatMapping", () => {
    ...
    expect(LayerFactory.wfsFormatMapping.GML2).to.equal(
      "text/xml; subtype=gml/2.1.2"
    );
    expect(LayerFactory.wfsFormatMapping.GML3).to.equal(
      "text/xml; subtype=gml/3.1.1"
    );
    expect(LayerFactory.wfsFormatMapping.GML32).to.equal(
  ...
  describe("layer types", () => {
    ...
    it("createImageWmsLayer returns correct layer instance", () => {
      ...
      expect(layer.getSource().getParams().LAYERS).to.equal(
